...
public class Article {
	...
	@Builder
	Article(final String id, final String title, final String description, final String body,

			@Nullable final Instant createdAt, @Nullable final Instant updatedAt, final String authorId,
			@Nullable final List<String> tags, @Nullable final List<Comment> comments,
	...
	public Article deleteComment(final Comment comment) {
		...
		return this; // return the instance of this object xd
	}
