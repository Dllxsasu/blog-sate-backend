...
public class User {
	...
	public User(final String id, @Nullable final List<String> followingIds, final String username,
			final String encodedPassword, final String email, @Nullable final String bio,
